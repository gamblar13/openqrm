...
class citrix_storage_discovery_select
{
/**
...
var $lang = array();
	...
	function action() {
		$table = $this->select();
		$t = $this->response->html->template($this->tpldir.'/citrix-storage-discovery-select.tpl.php');
	...
	function select() {
		...
		$citrix_storage_discovery_array = $this->discovery->display_overview($table->offset, $table->limit, $table->sort, $table->order);
		foreach ($citrix_storage_discovery_array as $index => $esx) {
