...
var $lang = array();
	...
	function action() {
		...
		$t = $this->response->html->template($this->tpldir.'/citrix-storage-vm-clone.tpl.php');
	...
	function vm_clone() {
		...
		if(!$form->get_errors() && $this->response->submit()) {
			...
			$command     = $this->openqrm->get('basedir').'/plugins/citrix-storage/bin/openqrm-citrix-storage-vm clone';
