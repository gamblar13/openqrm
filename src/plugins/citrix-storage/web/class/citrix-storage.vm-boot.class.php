...
var $lang = array();
	...
	function vm_boot() {
		...
		$command  = $this->openqrm->get('basedir')."/plugins/citrix-storage/bin/openqrm-citrix-storage setboot_by_name -i ".$this->resource->ip." -n ".$vm_name." -b ".$new_vm_boot_order;
