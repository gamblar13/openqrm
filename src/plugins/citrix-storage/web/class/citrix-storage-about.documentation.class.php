<?php
/**
 * citrix-storage-about Documentation
 *
...
class citrix_storage_about_documentation
{
/**
...
var $lang = array();
	...
	//--------------------------------------------
	function action() {
		$t = $this->response->html->template($this->tpldir.'/citrix-storage-about-documentation.tpl.php');
