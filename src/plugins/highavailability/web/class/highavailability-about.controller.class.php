...
var $lang = array(
	'documentation' => array (
		...
		'introduction_content' => 'The highavailability-plugin automatically provides Highavailability for appliances managed by openQRM.<br>
			In case the appliance resource is not reachable after the configured timeout (e.g. 2 minutes), openQRM will try to find a new resource fitting the appliance profile to re-start/re-deploy the appliance.',
		...
		'provides_list' => '<li>Highavailability for appliances managed by openQRM</li>',

		'howto_title' => 'How to use',
		'howto_list' => '<li>Use	the HA-Manager to select the appliances that should be highavailable.</li>',
	...
	function documentation( $hidden = true ) {
		...
		if( $hidden === true ) {
			...
			$controller = new highavailability_about_documentation($this->openqrm, $this->response);
