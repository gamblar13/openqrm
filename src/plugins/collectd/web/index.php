...
require_once $RootDir."/plugins/collectd/class/collectd.controller.class.php";
...
$action = new collectd_controller($openqrm, $response);
...
<link rel="stylesheet" type="text/css" href="css/collectd.css" />
