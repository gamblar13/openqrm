...
if(htmlobject_request('xen_command') != '') {
    switch ($xen_command) {
        case 'new':
            ...
            sleep(5);
            // send command
            $resource_command="$OPENQRM_SERVER_BASE_DIR/openqrm/plugins/xen-storage/bin/openqrm-xen-storage-vm create -n $xen_name -m $xen_mac -r $xen_ram -c $xen_cpus -z $xen_vm_bridge -b $xen_vm_boot_dev $xen_vm_boot_iso -u $OPENQRM_USER->name -p $OPENQRM_USER->password";
