<?php
/**
 * openvz-storage-about Documentation
 *
...
class openvz_storage_about_documentation
{
/**
...
var $lang = array();
	...
	//--------------------------------------------
	function action() {
		$t = $this->response->html->template($this->tpldir.'/openvz-storage-about-documentation.tpl.php');
