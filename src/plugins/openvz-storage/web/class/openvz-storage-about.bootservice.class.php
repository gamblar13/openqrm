<?php
/**
 * openvz-storage-about Boot-Service
 *
...
class openvz_storage_about_bootservice
{
/**
...
var $lang = array();
	...
	//--------------------------------------------
	function action() {
		$t = $this->response->html->template($this->tpldir.'/openvz-storage-about-bootservice.tpl.php');
