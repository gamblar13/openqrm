...
class openvz_storage_vm_reboot
{
/**
	...
	function reboot() {
		...
		if( $vms !== '' ) {
			...
			foreach($vms as $key => $vm) {
				...
				$command  = $this->openqrm->get('basedir').'/plugins/openvz-storage/bin/openqrm-openvz-storage-vm reboot -n '.$vm;
