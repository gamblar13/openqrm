...
var $lang = array();
	...
	function init() {
		...
		$this->statfile   = $this->openqrm->get('basedir').'/plugins/openvz-storage/web/storage/'.$resource->id.'.vg.stat';
	}
	...
	function action() {
		...
		$data = $this->edit();
		if($data !== false) {
			$t = $this->response->html->template($this->tpldir.'/openvz-storage-edit.tpl.php');
