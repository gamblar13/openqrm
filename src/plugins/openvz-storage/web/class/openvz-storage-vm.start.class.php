	...
	function start() {
		...
		if( $vms !== '' ) {
			...
			foreach($vms as $key => $vm) {
				...
				$command  = $this->openqrm->get('basedir').'/plugins/openvz-storage/bin/openqrm-openvz-storage-vm start -n '.$vm;
