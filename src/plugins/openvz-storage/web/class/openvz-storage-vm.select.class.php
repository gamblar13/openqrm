<?php
/**
 * openvz-storage-vm Select Storage
 *
...
class openvz_storage_vm_select
{
/**
...
var $lang = array();
	...
	function action() {
		$table = $this->select();
		$t = $this->response->html->template($this->tpldir.'/openvz-storage-vm-select.tpl.php');
	...
	function select() {
		...
		$table = $this->response->html->tablebuilder('openvz_vm', $this->response->get_array($this->actions_name, 'select'));
