 ...
 */
		...
		$this->response = $this->html->response('wakeuponlan-construct');
	...
	function select( $hidden = true ) {
		...
		if( $hidden === true ) {
			...
			$controller = new wakeuponlan_select($this->response, $this->db);
...
//			$this->response->html->help($data);
	...
	function sleep( $hidden = true ) {
		...
		if( $hidden === true ) {
			...
			$controller = new wakeuponlan_sleep($this->response, $this->db);
			$controller->actions_name  = $this->actions_name;
			$controller->tpldir        = $this->rootdir.'/plugins/wakeuponlan/tpl';
			$controller->identifier_name = $this->identifier_name;
			$controller->message_param = $this->message_param;
...
//			$this->response->html->help($data);
	...
	function enable( $hidden = true ) {
		...
		if( $hidden === true ) {
			...
			$controller = new wakeuponlan_enable($this->response, $this->db);
			$controller->actions_name  = $this->actions_name;
			$controller->tpldir        = $this->rootdir.'/plugins/wakeuponlan/tpl';
			$controller->identifier_name = $this->identifier_name;
			$controller->message_param = $this->message_param;
...
//			$this->response->html->help($data);
	...
	function disable( $hidden = true ) {
		...
		if( $hidden === true ) {
			...
			$controller = new wakeuponlan_disable($this->response, $this->db);
			$controller->actions_name  = $this->actions_name;
			$controller->tpldir        = $this->rootdir.'/plugins/wakeuponlan/tpl';
			$controller->identifier_name = $this->identifier_name;
			$controller->message_param = $this->message_param;
