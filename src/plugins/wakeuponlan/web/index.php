...
require_once $RootDir."/plugins/wakeonlan/class/wakeonlan.controller.class.php";
...
$action = new wakeonlan_controller($openqrm, $response);
...
<link rel="stylesheet" type="text/css" href="css/wakeonlan.css" />
