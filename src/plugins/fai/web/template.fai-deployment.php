...
function get_fai_deployment_additional_parameters() {
	...
	$local_deployment_additional_parameters .= htmlobject_input('local_deployment_additional_parameter1', array("value" => "", "label" => '<nobr>Add. Class 1&nbsp;&nbsp;&nbsp;</nobr>'), 'text', 20);
	$local_deployment_additional_parameters .= htmlobject_input('local_deployment_additional_parameter2', array("value" => "", "label" => '<nobr>Add. Class 2&nbsp;&nbsp;&nbsp;</nobr>'), 'text', 20);
	$local_deployment_additional_parameters .= htmlobject_input('local_deployment_additional_parameter3', array("value" => "", "label" => '<nobr>Add. Class 3&nbsp;&nbsp;&nbsp;</nobr>'), 'text', 20);
	$local_deployment_additional_parameters .= htmlobject_input('local_deployment_additional_parameter4', array("value" => "", "label" => '<nobr>Add. Class 4&nbsp;&nbsp;&nbsp;</nobr>'), 'text', 20);
