...
// This class represents a fairesource object in openQRM
...
function set_boot($resource_id, $boot) {
	...
	switch($fai_resource_virtualization->type) {
		case 'kvm-vm':
			...
			$fai_resource_set_boot_commmand = $this->_base_dir."/openqrm/plugins/kvm/bin/openqrm-kvm setboot -m ".$fai_resource->mac." -b ".$boot_sequence;
		...
		case 'kvm-storage-vm':
			$fai_resource_vhost = new resource();
			$fai_resource_vhost->get_instance_by_id($fai_resource->vhostid);
			$fai_resource_set_boot_commmand = $this->_base_dir."/openqrm/plugins/kvm-storage/bin/openqrm-kvm-storage-vm setboot -m ".$fai_resource->mac." -b ".$boot_sequence;
			$fai_resource_vhost->send_command($fai_resource_vhost->ip, $fai_resource_set_boot_commmand);
