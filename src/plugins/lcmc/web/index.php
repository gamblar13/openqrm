...
require_once $RootDir."/plugins/lcmc/class/lcmc.controller.class.php";
...
$action = new lcmc_controller($openqrm, $response);
...
<link rel="stylesheet" type="text/css" href="css/lcmc.css" />
