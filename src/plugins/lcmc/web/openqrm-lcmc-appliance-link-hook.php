...
function get_lcmc_appliance_link($appliance_id) {
	...
	$a = $html->a();
	$a->label = '<img title="'.$icon_title.'" alt="'.$icon_title.'" $icon_size src="/openqrm/base/plugins/lcmc/img/plugin.png" border=0>';
	$a->href = '#';
	$a->handler = 'onclick="window.open(\''.$lcmc_gui.'\',\'\', \'location=0,status=0,scrollbars=1,width=1024,height=768,left=50,top=50,screenX=50,screenY=50\');return false;"';
