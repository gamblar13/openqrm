...
* @var string
*/
var $actions_name = 'linuxcoe-action';
/**
* message param
* @access public
* @var string
*/
var $message_param = "msg-linuxcoe";
/**
* openqrm rootdir
* @access public
* @var string
		...
		if(!$form->get_errors() && $this->response->submit()) {
			if(!$form->get_errors()) {
				...
				if(isset($error)) {
					...
					// add volume
					$volume_fields = array();
					$volume_fields["linuxcoe_volume_id"] = openqrm_db_get_free_id('linuxcoe_volume_id', $linuxcoe_volume->_db_table);
