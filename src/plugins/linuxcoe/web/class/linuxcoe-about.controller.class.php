...
var $lang = array(
	'documentation' => array (
		...
		'requirements_list' => '<li>A LinuxCOE Install Server Storage using the openQRM as the resource</li>
				   <li>The following packages must be installed: screen, make, autoconf, automake, genisoimage, sudo, nfs-kernel-server, nfs-common</li>',

		'tested_title' => 'Tested with',
		'tested_content' => 'This plugin is tested with the Debian, Ubuntu and CentOS Linux distributions.',

		'provides_title' => 'Provides',
		'provides_list' => '<li>Storage type: "linuxcoe-deployment"</li>
					<li>Deployment types: "Automatic Linux Installation (LinuxCOE)"</li>',

		'howto_title' => 'How to use',
		'howto_list' => '<li>Create a new Storage from type "linuxcoe-deployment" using the openQRM Server as the resource</li>
					...
					<li>Choose either <strong>Automatic Installations from ISO</strong> or <strong>Automatic Network-Installations</strong> to deploy the Templates</li>',
