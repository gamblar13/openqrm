...
require_once $RootDir."/plugins/sshterm/class/sshterm.controller.class.php";
...
$action = new sshterm_controller($openqrm, $response);
...
<link rel="stylesheet" type="text/css" href="css/sshterm.css" />
