...
var $actions_name = 'cloud_selector';
	...
	function down() {
		...
		$this->response->msg = $this->lang['cloud_selector_product_sort_down_successful'];
		$this->response->product_type = $product_type;
		$this->cloudselector->sort("down", $cloud_selector_id, $product_type);
