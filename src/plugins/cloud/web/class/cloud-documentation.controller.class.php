...
class cloud_documentation_controller
{
/**
...
* @var string
*/
var $message_param = "msg-cloud-documentation";
/**
* id for tabs
* @access public
* @var string
...
var $lang = array(
	...
	function about( $hidden = true ) {
		$data = '';
		if( $hidden === true ) {
			require_once($this->rootdir.'/plugins/cloud/class/cloud-documentation.about.class.php');
			$controller = new cloud_documentation_about($this->openqrm, $this->response);
	...
	function soap( $hidden = true ) {
		$data = '';
		if( $hidden === true ) {
			require_once($this->rootdir.'/plugins/cloud/class/cloud-documentation.soap.class.php');
			$controller = new cloud_documentation_soap($this->openqrm, $this->response);
			$controller->actions_name    = $this->actions_name;
			$controller->tpldir          = $this->tpldir;
			$controller->identifier_name = $this->identifier_name;
			$controller->message_param = $this->message_param;
