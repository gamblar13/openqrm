...
class cloud_documentation_soap
{
var $tpldir;
var $lang;
var $actions_name = 'cloud-documentation-soap';
	...
	function action() {
	    ...
	    foreach ($lines as $line_num => $line) {
		    if (strstr($line, "function ")) {
			    ...
			    $soap_admin_function_list .= "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>".$function_name."</b><br />\n";
			    $soap_user_function_list .= "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>".$function_name."</b><br />\n";
		    }
	    }
