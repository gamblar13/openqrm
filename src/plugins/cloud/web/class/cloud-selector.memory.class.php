...
var $actions_name = 'cloud_selector';
	...
	//--------------------------------------------
	function action() {
		$response = $this->memory();
		$template = $this->response->html->template($this->tpldir."/cloud-selector-memory.tpl.php");
	...
	function memory() {
		...
		$table = $response->html->tablebuilder( 'cloud-selector-table', $this->response->get_array($this->actions_name, 'memory'));
		...
		$table->sort            = 'sort_id';
		$table->autosort        = true;
		$table->max				= $this->cloudselector->get_count_by_type("memory");
		$table->identifier      = 'id';
		...
		$cloud_selector_array = $this->cloudselector->display_overview_per_type("memory");
		$ta = '';
