...
<h1><img border=0 src="/openqrm/base/img/monitoring.png"> {cloud_selector_memory} {cloud_selector_products}</h1>
...
<div id="add_product">
	<nobr>
	<input type="text" name="product_quantity" class="quantity_slider-input" id="quantity_slider-input" maxlength="10" size="10" value="512"/>  MB {cloud_selector_memory}
