...
<h1><img border=0 src="/openqrm/base/img/deployment.png"> {cloud_selector_disk} {cloud_selector_products}</h1>
...
<div id="add_product">
	<nobr>
	<input type="text" name="product_quantity" class="quantity_slider-input" id="quantity_slider-input" maxlength="2" size="2" value="1"/> {cloud_selector_disk}
