...
<h1><img border=0 src="/openqrm/base/img/virtualization.png"> {cloud_selector_resource} {cloud_selector_products}</h1>
...
<div id="add_product">
	...
	<input type="hidden" name="product_type" value="resource">
