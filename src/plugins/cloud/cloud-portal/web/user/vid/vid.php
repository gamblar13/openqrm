            ...
            foreach ($arr as $p){
                ...
                switch ($sobject_type) {
                    ...
                    case 'p':
                        ...
                        // create cma
                        $event->log("openqrm-vid", $_SERVER['REQUEST_TIME'], 5, "openqrm-vid.php", "Requesting Cloud Profile $lobject_id", "", "", 0, 0, 0);
                                ...
                                case 'active':
                                    ...
                                    if ($info_resource->imageid == 1) {
                                        ...
                                        if (file_exists("$RootDir/plugins/sshterm/.running")) {
                                            ...
                                            extract($store);
                                            // TODO : ip needs to be re-checked, maybe it is not the mgmt ip
                                            $info_resource = new resource();
                                            $info_resource->get_instance_by_id($info_appliance->resources);
