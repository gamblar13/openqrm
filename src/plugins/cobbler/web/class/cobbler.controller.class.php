 ...
 */
		...
		require_once $this->rootdir."/plugins/cobbler/class/cobbler.class.php";
		$this->db = new cobbler();
		...
		$this->html->lang = $this->user->translate($this->html->lang, $this->rootdir."/plugins/cobbler/lang", 'htmlobjects.ini');
		$this->response = $this->html->response('cobbler-construct');
	...
	function select( $hidden = true ) {
		...
		if( $hidden === true ) {
			...
			$controller = new cobbler_select($this->response, $this->db);
			$controller->actions_name    = $this->actions_name;
			$controller->tpldir          = $this->tpldir;
			$controller->identifier_name = $this->identifier_name;
//			$controller->message_param = $this->message_param;
//			$controller->settings      = DATADIR.'/project.ini';
			$controller->lang          = $this->user->translate($this->lang, $this->rootdir."/plugins/cobbler/lang", 'cobbler.ini');
