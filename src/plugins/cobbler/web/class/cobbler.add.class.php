...
* @var string
*/
var $actions_name = 'cobbler-action';
/**
* message param
* @access public
* @var string
...
var $lang = array();
	...
	function action() {
		...
		$t = $this->response->html->template($this->tpldir.'/cobbler-add.tpl.php');
		...
		if(!$form->get_errors() && $this->response->submit()) {
			if(!$form->get_errors()) {
				...
				if(isset($error)) {
					...
					$volume_fields['cobbler_volume_root'] = $root;
					$volume_fields['cobbler_volume_description'] = $description;
