...
require_once $RootDir."/plugins/dhcpd/class/dhcpd-about.controller.class.php";
...
$action = new dhcpd_about_controller($openqrm, $response);
...
<link rel="stylesheet" type="text/css" href="css/dhcpd.css" />
