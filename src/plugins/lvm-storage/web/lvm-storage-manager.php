...
// to gather one of the deployment types within lvm-storage
...
function lvm_select_storage() {
    ...
    switch ($lvm_storage_type) {
        case 'nfs':
            $t_deployment->get_instance_by_type("lvm-nfs-deployment");
            break;
        case 'aoe':
            $t_deployment->get_instance_by_type("lvm-aoe-deployment");
            break;
        case 'iscsi':
            $t_deployment->get_instance_by_type("lvm-iscsi-deployment");
            break;
