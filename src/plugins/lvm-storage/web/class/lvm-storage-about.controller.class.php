...
var $lang = array(
	'documentation' => array (
		...
		'requirements_list' => '<li>A resource for the LVM-Storage Storage (this can be a remote system integrated into openQRM e.g. via the "local-server" plugin or the openQRM server itself)</li>
					<li>One (or more) lvm volume group(s) with free space dedicated for the LVM-Storage Volumes</li>
				   <li>The following packages must be installed: nfs-common, nfs-kernel-server, screen, rsync, vblade, aoetools, iscsitarget, open-iscsi</li>',

		'tested_title' => 'Tested with',
		'tested_content' => 'This plugin is tested with the Debian, Ubuntu and CentOS Linux distributions.',

		'provides_title' => 'Provides',
		'provides_list' => '<li>Storage type: "Lvm Storage Server (Aoe/Nfs/Iscsi)"</li>
