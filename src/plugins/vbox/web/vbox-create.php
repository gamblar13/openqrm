	...
	if ($OPENQRM_USER->role == "administrator") {
		...
		switch ($action) {
			case 'new':
				...
				// final command
				$resource_command="$OPENQRM_SERVER_BASE_DIR/openqrm/plugins/vbox/bin/openqrm-vbox create -n $vbox_server_name -m $vbox_server_mac -r $vbox_server_ram -c $vbox_server_cpus $vbox_server_disk_parameter $vbox_server_swap_parameter -u $OPENQRM_ADMIN->name -p $OPENQRM_ADMIN->password";
