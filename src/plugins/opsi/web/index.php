...
require_once $RootDir."/plugins/opsi/class/opsi.controller.class.php";
...
$action = new opsi_controller($openqrm, $response);
...
<link rel="stylesheet" type="text/css" href="css/opsi.css" />
