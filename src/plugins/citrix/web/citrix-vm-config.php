...
function citrix_vm_config() {
	...
	if (isset($store['OPENQRM_CITRIX_VM_MAC_1'])) {
	...
	if (isset($store['OPENQRM_CITRIX_VM_MAC_2'])) {
	...
	if (isset($store['OPENQRM_CITRIX_VM_MAC_3'])) {
	...
	if (isset($store['OPENQRM_CITRIX_VM_MAC_4'])) {
