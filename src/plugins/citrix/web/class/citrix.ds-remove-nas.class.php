...
var $lang = array();
	...
	function action() {
		...
		$t = $this->response->html->template($this->tpldir.'/citrix-ds-remove-nas.tpl.php');
	...
	function ds_remove_nas() {
		...
		if( $this->ds_name !== '' ) {
			...
			if(!$form->get_errors() && $response->submit()) {
				$command     = $this->openqrm->get('basedir')."/plugins/citrix/bin/openqrm-citrix-datastore remove_nas -i ".$this->resource->ip." -n ".$this->ds_name;
