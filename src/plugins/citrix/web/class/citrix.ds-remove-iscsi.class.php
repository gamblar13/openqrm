...
var $lang = array();
	...
	function action() {
		...
		$t = $this->response->html->template($this->tpldir.'/citrix-ds-remove-iscsi.tpl.php');
		...
		if( $this->ds_name !== '' ) {
			...
			if(!$form->get_errors() && $response->submit()) {
				...
				if(isset($error)) {
					...
					$command     = $this->openqrm->get('basedir')."/plugins/citrix/bin/openqrm-citrix-datastore remove_iscsi -i ".$this->resource->ip." -n ".$this->ds_name;
