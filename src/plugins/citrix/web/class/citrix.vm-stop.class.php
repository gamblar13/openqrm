...
var $lang = array();
	...
	function action() {
		...
		$t = $this->response->html->template($this->tpldir.'/citrix-vm-stop.tpl.php');
		...
		if( $data !== '' ) {
			...
			if(!$form->get_errors() && $response->submit()) {
				...
				foreach($data as $key => $vm) {
					$command  = $this->openqrm->get('basedir')."/plugins/citrix/bin/openqrm-citrix-vm stop -i ".$this->resource->ip." -n ".$vm;
