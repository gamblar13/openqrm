...
//		}
		...
		$t = $this->response->html->template($this->tpldir.'/citrix-discovery-delete.tpl.php');
		...
		$t->add($this->lang['citrix_host_discovery_confirm_delete'], 'confirm_delete');
