...
var $lang = array();
	...
	function action() {
		...
		$t = $this->response->html->template($this->tpldir.'/citrix-vm-reboot.tpl.php');
		...
		if( $data !== '' ) {
			...
			if(!$form->get_errors() && $response->submit()) {
				...
				foreach($data as $key => $citrix) {
					...
					$command  = $this->openqrm->get('basedir')."/plugins/citrix/bin/openqrm-citrix host_reboot -i ".$citrix_host_resource->ip;
