...
var $lang = array(
	'documentation' => array (
		...
		'requirements_list' => '<li>A resource for the TmpFs-Storage Storage (this can be a remote system integrated into openQRM e.g. via the "local-server" plugin or the openQRM server itself)</li>',

		'tested_title' => 'Tested with',
		'tested_content' => 'This plugin is tested with the Debian, Ubuntu and CentOS Linux distributions.',

		'provides_title' => 'Provides',
		'provides_list' => '<li>Storage type: "TmpFs Storage"</li><li>Deployment types: "Tmpfs-root deployment"</li>',
