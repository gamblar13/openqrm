...
function get_nagios3_appliance_edit($appliance_id) {
	global $event;
	global $OPENQRM_SERVER_BASE_DIR;
	global $OPENQRM_SERVER_IP_ADDRESS;
	global $OPENQRM_EXEC_PORT;
	...
	$nagios_link = 'index.php?plugin=nagios3&nagios3_action=appliance&nagios3_appliance=edit&appliance_id='.$appliance_id;
