...
require_once $RootDir."/plugins/nagios3/class/nagios3.controller.class.php";
...
$action = new nagios3_controller($openqrm, $response);
...
<link rel="stylesheet" type="text/css" href="css/nagios3.css" />
