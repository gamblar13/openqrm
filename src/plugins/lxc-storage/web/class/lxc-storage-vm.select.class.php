...
var $lang = array();
	...
	function action() {
		$table = $this->select();
		$t = $this->response->html->template($this->tpldir.'/lxc-storage-vm-select.tpl.php');
	...
	function select() {
		...
		$table = $this->response->html->tablebuilder('lxc_vm', $this->response->get_array($this->actions_name, 'select'));
