...
if(htmlobject_request('action') != '') {
    ...
    switch ($action) {
        case 'new':
            ...
            // final command
            $resource_command="$OPENQRM_SERVER_BASE_DIR/openqrm/plugins/lxc-storage/bin/openqrm-lxc-storage-vm create -n $lxc_server_name -m $lxc_server_mac -i $lxc_server_ip $additional_network_parameters -u $OPENQRM_USER->name -p $OPENQRM_USER->password";
