...
function get_image_rootdevice_identifier($lvm_nfs_storage_id) {
    ...
    // send command
	$resource_command="$OPENQRM_SERVER_BASE_DIR/openqrm/plugins/lxc-storage/bin/openqrm-lxc-storage post_identifier -u $OPENQRM_USER->name -p $OPENQRM_USER->password";
