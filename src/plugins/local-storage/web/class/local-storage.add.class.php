...
* @var string
*/
var $actions_name = 'local-storage-action';
/**
* message param
* @access public
* @var string
*/
var $message_param = "msg-local-storage";
/**
* openqrm rootdir
* @access public
* @var string
...
var $lang = array();
	...
	function action() {
		...
		$t = $this->response->html->template($this->tpldir.'/local-storage-add.tpl.php');
		...
		if(!$form->get_errors() && $this->response->submit()) {
			if(!$form->get_errors()) {
				...
				if(isset($error)) {
					...
					$volume_fields['local_storage_volume_root'] = $root;
					$volume_fields['local_storage_volume_description'] = $description;
