...
var $lang = array();
	...
	function action() {
		$table = $this->select();
		$t = $this->response->html->template($this->tpldir.'/local-storage-select.tpl.php');
	...
	function select() {
		...
		$deployment->get_instance_by_type("local-storage");
		$table = $this->response->html->tablebuilder('local', $this->response->get_array($this->actions_name, 'select'));
