...
var $lang = array();
	...
	function action() {
		...
		$t = $this->response->html->template($this->tpldir.'/aoe-storage-auth.tpl.php');
	...
	function auth() {
		...
		if( $export !== '' ) {
			...
			if(!$form->get_errors() && $response->submit()) {
				...
				$statfile = $this->openqrm->get('basedir').'/plugins/aoe-storage/web/storage/'.$resource->id.'.aoe.stat';

				$error = '';
				$command  = $this->openqrm->get('basedir').'/plugins/aoe-storage/bin/openqrm-aoe-storage auth';
