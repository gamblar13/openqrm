...
var $lang = array();
	...
	function action() {
		$table = $this->select();
		$t = $this->response->html->template($this->tpldir.'/aoe-storage-select.tpl.php');
	...
	function select() {
		...
		$deployment->get_instance_by_type("aoe-deployment");
		$table = $this->response->html->tablebuilder('aoe', $this->response->get_array($this->actions_name, 'select'));
