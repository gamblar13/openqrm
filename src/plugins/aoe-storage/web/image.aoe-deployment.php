...
function aoe_deployment_wait_for_identfile($sfile) {
	$refresh_delay=1;
	$refresh_loop_max=20;
	$refresh_loop=0;
...
function get_aoe_deployment_image_rootdevice_identifier($aoe_storage_id) {
	global $OPENQRM_SERVER_BASE_DIR;
	...
	if (!aoe_deployment_wait_for_identfile($ident_file)) {
...
function get_aoe_deployment_image_default_rootfs() {
	return "ext3";
}

function get_aoe_deployment_rootfs_transfer_methods() {
	return true;
}

function get_aoe_deployment_rootfs_set_password_method() {
	return true;
}

function get_aoe_deployment_is_network_deployment() {
	return true;
}

function get_aoe_deployment_local_deployment_enabled() {
	return false;
}
