...
function open_novnc(url, title, left, top) {
	novnc_window = window.open(url, title, "width=580,height=420,scrollbars=1,left=" + left + ",top=" + top);
	open_novnc.focus();
}
</script>

<h1><img border=0 src="{baseurl}/plugins/novnc/img/plugin.png"> {label}</h1>
<div id="form">
	{table}
</div>
