...
require_once $RootDir."/plugins/novnc/class/novnc.controller.class.php";
...
$action = new novnc_controller($openqrm, $response);
...
<link rel="stylesheet" type="text/css" href="css/novnc.css" />
