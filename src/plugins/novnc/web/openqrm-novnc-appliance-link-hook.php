...
function get_novnc_appliance_link($appliance_id) {
	...
	$a = $html->a();
	$a->label = '<image height="24" width="24" alt="VNC-Login to '.$p_appliance->name.'" title="VNC-Login to '.$p_appliance->name.'" src="/openqrm/base/img/menu/novnc/plugin.png">';
	$a->href = '/openqrm/base/index.php?plugin=novnc&controller=novnc&novnc_action=login&novnc_identifier='.$p_appliance->id;
	$a->handler = '';
