...
require_once $RootDir."/plugins/tftpd/class/tftpd-about.controller.class.php";
...
$action = new tftpd_about_controller($openqrm, $response);
...
<link rel="stylesheet" type="text/css" href="css/tftpd.css" />
