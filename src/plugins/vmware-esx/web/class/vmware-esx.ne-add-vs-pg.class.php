...
var $lang = array();
	...
	function action() {
		...
		$t = $this->response->html->template($this->tpldir.'/vmware-esx-ne-add-vs-pg.tpl.php');
	...
	function ne_add_vs_pg() {
		...
		if(!$form->get_errors() && $this->response->submit()) {
			...
			$command		= $OPENQRM_SERVER_BASE_DIR."/openqrm/plugins/vmware-esx/bin/openqrm-vmware-esx-network add_pg -i ".$this->resource->ip." -n ".$vs_name." -g ".$name." -v ".$vlan;
	...
	function get_response() {
		...
		$form = $response->get_form($this->actions_name, 'ne_add_vs_pg');
