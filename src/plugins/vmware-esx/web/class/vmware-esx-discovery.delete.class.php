...
//		}
		...
		$template = $this->response->html->template($this->tpldir.'/vmware-esx-discovery-delete.tpl.php');
	...
	function get_response() {
		...
		if( $todelete !== '' ) {
			...
			foreach($todelete as $esx_ad_id) {
				$this->discovery->get_instance_by_id($esx_ad_id);
				$d['param_f'.$i]['label']                       = "<nobr>ID: ".$esx_ad_id."<br>".$this->discovery->vmw_esx_ad_ip."/".$this->discovery->vmw_esx_ad_mac."</nobr>";
