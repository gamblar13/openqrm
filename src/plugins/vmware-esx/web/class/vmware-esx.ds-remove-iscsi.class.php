		...
		if( $this->ds_name !== '' ) {
			...
			if(!$form->get_errors() && $response->submit()) {
				...
				if(isset($error)) {
					...
					$command     = $OPENQRM_SERVER_BASE_DIR."/openqrm/plugins/vmware-esx/bin/openqrm-vmware-esx-datastore remove_iscsi -i ".$this->resource->ip." -n ".$this->ds_name." -t ".$target." -q ".$ip;
