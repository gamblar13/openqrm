...
var $lang = array();
	...
	function edit() {
		...
		$d['icon'] = '<img width="24" height="24" src="'.$this->openqrm->get('baseurl').'/plugins/kvm/img/plugin.png">';
				...
				foreach($lines as $line) {
					if($line !== '') {
						...
						if($state !== '2') {						
							...
							// progressbar
							$t->add(uniqid('b'), 'id');
							$t->add($this->openqrm->get('baseurl').'/plugins/kvm/kvm-stat/'.$name.'.vm_migration_progress', 'url');
