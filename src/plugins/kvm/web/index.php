...
require_once $RootDir."/plugins/kvm/class/kvm.controller.class.php";
...
$action = new kvm_controller($openqrm, $response);
...
<link rel="stylesheet" type="text/css" href="css/kvm.css" />
