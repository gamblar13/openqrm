...
function get_image_rootdevice_identifier($sanboot_aoe_storage_id) {
	global $OPENQRM_SERVER_BASE_DIR;
	...
	// send command
	$resource_command="$OPENQRM_SERVER_BASE_DIR/openqrm/plugins/sanboot-storage/bin/openqrm-sanboot-storage post_identifier -t aoe-san-deployment -u $OPENQRM_ADMIN->name -p $OPENQRM_ADMIN->password";
