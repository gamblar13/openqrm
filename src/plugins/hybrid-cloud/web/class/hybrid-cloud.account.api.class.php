...
class hybrid_cloud_account_api
{
/**
...
var $actions_name = 'hybrid_cloud_account_action';
	...
	function __construct($controller) {
		...
		$this->statfile  = $this->controller->openqrm->get('webdir').'/plugins/hybrid-cloud/stat/0.pick_iso_config';
	}
	...
	function filepicker() {
		...
		if ($iso_path !== '') {
		    ...
		    $command  = $this->controller->openqrm->get('basedir')."/plugins/hybrid-cloud/bin/openqrm-hybrid-cloud iso";
		    $command .= ' -q '.$iso_path;
