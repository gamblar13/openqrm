...
<div id="form" class="account">
	...
	<div style="float:left;">
		...
		<div style="float:left;">
			<input type="button" id="namegenerate" onclick="namegen(); return false;" class="browse-button" value="{lang_name_generate}" style="display:none;">
		</div>
...
function namegen() {
	...
	document.getElementById('name').value = 'account_'+name;
}
