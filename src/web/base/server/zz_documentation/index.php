...
require_once "$RootDir/server/zz_documentation/class/documentation.controller.class.php";
...
$openqrm = new openqrm();
$openqrm->init();
$action = new documentation_controller($openqrm, $response);
...
<html>
<head>
<title>openQRM Documentation</title>
