...
var $lang = array(
	'select' => array (
		...
		'lang_filter' => 'Filter by resource type',
	...
	'remove' => array (
		...
		'msg_not_removing' => 'Not removing resource %s!<br>It is still in use by appliance %s !',
...
//		$response->html->debug();
	...
	function action($action = null) {
		...
		switch( $this->action ) {
			...
			case $this->lang['select']['action_reboot']:
			case 'reboot':
				$content[] = $this->select(false);
				$content[] = $this->reboot(true);
			break;

			case $this->lang['select']['action_poweroff']:
			case 'poweroff':
				$content[] = $this->select(false);
