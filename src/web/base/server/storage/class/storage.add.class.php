...
var $lang = array();
	...
	function get_response() {
		...
		$deployment_type_select = $deployment->get_list();
		...
		foreach ($resource_arr as $index => $resource_db) {
			...
			$resource_select[] = array('value' => $res_id, 'label' => 'ID '.$res_id.' / '.$storage_resource->ip.' '.$storage_resource->hostname);
		}
		...
		$d['capabilities']['object']['attrib']['maxlength'] = 50;
		...
		$d['comment']['object']['attrib']['maxlength'] = 50;
		...
		$d['resource']['object']['attrib']['index']   = array('value', 'label');
