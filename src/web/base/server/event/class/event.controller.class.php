...
var $lang = array(
	...
	function action($action = null) {
		...
		switch( $this->action ) {
			...
			break;
			case $this->lang['select']['action_acknowledge']:
			case 'acknowledge':
				$content[] = $this->acknowledge(true);
			break;
			case $this->lang['select']['action_rerun']:
			case 'rerun':
	...
	function acknowledge( $hidden = true ) {
		...
		$content['onclick'] = false;
		if($this->action === 'acknowledge' || $this->action === $this->lang['select']['action_acknowledge']){
			$content['active']  = true;
		}
		return $content;
	}
	...
	function rerun( $hidden = true ) {
		...
		$content['onclick'] = false;
		if($this->action === 'rerun' || $this->action === $this->lang['select']['action_rerun']){
			$content['active']  = true;
		}
		return $content;
	}
