...
switch ($step) {
	case 1:
		$output[] = array('label' => 'New Appliance', 'value' => appliance_form_step1());
		break;
	case 2:
		$output[] = array('label' => 'New Appliance', 'value' => appliance_form_step2($resource_id));
		break;
	case 3:
		$output[] = array('label' => 'New Appliance', 'value' => appliance_form_step3($resource_id, $image_id));
		break;
	default:
		$output[] = array('label' => 'New Appliance', 'value' => appliance_form_step1());
		break;
