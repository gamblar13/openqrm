...
$image_command = htmlobject_request('image_command');
?>
<html>
<head>
...
$deployment_description = htmlobject_request('deployment_description');
$deployment_storagetype = htmlobject_request('deployment_storagetype');
$deployment_storagedescription = htmlobject_request('deployment_storagedescription');
$deployment_mapping = htmlobject_request('deployment_mapping');
