...
var $lang = array();
	...
	function __construct($openqrm, $response) {
		...
		$this->response->params['install_server'] = $this->response->html->request()->get('install_server');
	}
	...
	function action() {
		...
		if(isset($response->local_deployment_templates_select)) {
			...
			if(isset($this->user->wizard_name) && $this->user->wizard_name === 'appliance' && $this->user->wizard_step == 5) {
